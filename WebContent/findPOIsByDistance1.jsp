	...
	<form action="FindPOIsByDistance" method="get">
		...
		<table>
			<tr>
				...
				<td><br /> Indirizzo: <input id="txtAddress" name="txtAddress"
					type="text"> <br /> Raggio (in Km): <input id="txtKm"
					name="txtKm" type="text" value="5"> <br /> <input
					id="btnSearch" type="submit" value="Search"> <br /> <% if (request.getAttribute("error") != null) { %>
