...
<head>
    ...
    <style>
        ...
        #googleMap { width: 100%; height: 100%; position: absolute; margin-top: 50px}

        #form {position: absolute; z-index: 90; width: 456px; top: 120px; left: 70px; -moz-transform: scale(1.2);

        }

        #background {position: absolute; z-index: 90; width: 456px; height: 260px; top: 140px; left: 50px; -moz-transform: scale(1.2);
